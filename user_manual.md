...
1. **Pending:** The bill has all of the required information (i.e. patient, and
   ...
   without the need of a bill adjustment. A bill enters this state when you
   click on "Save Bill" from the Bill Page.
1. **Posted:** The bill is automatically posted when the total of the
   payment(s) processed is not equal to the bill's total. It can also be
   manually posted using the "Post Bill" button.  Posted bills can be printed.
